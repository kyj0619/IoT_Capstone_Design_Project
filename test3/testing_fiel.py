...
x = keras.layers.Conv1D(32, kernel_size=7, activation="relu", name="conv1")(inputs)
x = keras.layers.MaxPooling1D(pool_size=2, name="maxpool1")(x)
x = keras.layers.Dropout(0.2)(x)
x = keras.layers.Conv1D(64, kernel_size=5, activation="relu", name="conv2")(x)
x = keras.layers.MaxPooling1D(pool_size=2, name="maxpool2")(x)
x = keras.layers.Dropout(0.2)(x)
x = keras.layers.Conv1D(128, kernel_size=3, activation="relu", name="conv3")(x)
x = keras.layers.MaxPooling1D(pool_size=2, name="maxpool3")(x)
x = keras.layers.Dropout(0.2)(x)
x = keras.layers.Conv1D(256, kernel_size=2, activation="relu", name="conv4")(x)
